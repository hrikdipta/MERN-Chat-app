...
const ChatListItem = ({chat}) => {
  ...
  return (
    <div className={`flex gap-5 border-y-2 p-2 mb-2 bg-gray-200 cursor-pointer rounded hover:bg-gray-300 ${currentChat===chat._id && "!bg-green-400"}`} onClick={()=>{dispatch(setCurrentChat(chat._id))}}>
